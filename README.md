...
Ostat includes the ofetch tool ([utils/ofetch](https://github.com/jamiealquiza/ostat/tree/master/utils/ofetch)) for quickly gathering metrics from a whole network of hosts in a highly parallelized fashion.
